...
public class MigrationService
{
    ...
    public async Task<MigrationResultDto> MigrateAsync(MigrationImportRequest request, Guid? callerOrgId = null)
    {
        ...
        {
            var column = new Column { Id = Guid.NewGuid(), ProjectId = project.Id, Name = c.Name, Done = c.Done, Color = c.Color, ColorBackground = c.ColorBackground, Order = c.Order, Cap = c.Cap < 1 ? -1 : c.Cap, IsBlocked = c.IsBlocked };
