...
/**
 * Ported from php-api/src/Controllers/FormsController.php. Org-Admin-only authoring of Enterprise
 * Forms (versions) — gated by OrgAdminMiddleware ONLY (see routes.php), same shape as
 * StrategyController. The read-only project-member surface lives in ProjectFormsController instead.
 */
