...
/** Ported from php-api's Controllers/UsersController.php. Self-service, current-user-only — every
 * signed-in user manages their own preferences, so this route is RequireAuthMiddleware only (no
