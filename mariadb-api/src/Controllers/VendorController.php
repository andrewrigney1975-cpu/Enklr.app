...
/** Ported from php-api's Controllers/VendorController.php. Org-Admin-only "Manage Vendors" surface —
 * CRUD plus per-Vendor API key generate/revoke, same callerOrgId() idiom as
 * OrganisationApiKeyController. */
