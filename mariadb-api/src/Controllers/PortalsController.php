...
/**
 * Ported from php-api/src/Controllers/PortalsController.php (itself ported from
 * Controllers/PortalsController.cs). Org-Admin authoring of Organisational Portals — gated by
 * OrgAdminMiddleware only (see routes.php). See PortalService's own doc comment for the cross-org
 * isolation guarantee every action here relies on.
 */
