...
/**
 * Ported from php-api/src/Services/PortalAccessService.php (itself ported from
 * Services/PortalAccessService.cs). The one shared access predicate for Organisational Portals —
 * independently re-derives whether a user has access to a Portal from its PortalAccessGrants rows,
 * never trusting a client-supplied claim. A Portal with zero grants is invisible to every org user —
 * closed by default. No dialect divergence from the Postgres tier anywhere in this file.
 */
