...
/**
 * Ported from Services/UserPreferencesService.cs. Self-service read/write of the one-per-User
 * personalization row (avatar + header colour) — a plain UPSERT since the row is created lazily on
 * first save, same "SELECT existing, then INSERT-or-UPDATE" shape as OrganisationSsoConfigService.
 */
