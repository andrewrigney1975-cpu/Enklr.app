...
/**
 * Ported from Services/PortalSlugResolver.cs. Mirrors the project-key derive-then-uniquify shape
 * for Portal Slug instead of Project Key — a human-readable, hashbang-routable (#!/portal/<slug>)
 * identifier, unique per Organisation.
 */
