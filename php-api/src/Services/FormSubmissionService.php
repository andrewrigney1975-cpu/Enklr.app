...
/**
 * Ported from Services/FormSubmissionService.cs. Project-member-facing Draft management for Form
 * submissions — single table for every form type (see the entity's own migration comment). Phase 1
 * scope: create/edit/delete a Draft only — Submit (entering the workflow, engine gate-checking,
 * CurrentNodeId advancement) is Phase 4/5, once the workflow engine exists to actually evaluate it.
 */
