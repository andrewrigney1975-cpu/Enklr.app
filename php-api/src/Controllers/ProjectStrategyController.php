...
/**
 * Ported from Controllers/ProjectStrategyController.cs. Read-only Strategy surface for regular
 * project members (ProjectMemberMiddleware, gated in routes.php). No CRUD lives here at all — every
