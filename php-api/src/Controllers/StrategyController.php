...
/**
 * Ported from Controllers/StrategyController.cs. Org-Admin-only management of Strategies/Pillars/
 * Enablers/Metrics + the fulfilment-matrix upsert and OrgAdmin-side read — gated by
 * OrgAdminMiddleware ONLY (see routes.php), same reasoning as PortfolioController. The read-only
 * ProjectMember surface lives in ProjectStrategyController instead.
 */
